...
(function ($) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_911, _912, _913) {
             ...
             * 2018-8-3
             */
            _911.limit = _911.rows;
            //移除rows属性
            delete _911.rows;
            $.ajax({
                type: opts.method,
                url: opts.url,
                data: JSON.stringify(_911),
                ...
                success: function (result) {
                    if (result.code == '0') {
                        let _2018 = new Object();
                        _2018.total = result.data.totalCount;
                        _2018.rows = result.data.list;
                        _2018.footer = result.data.footer;
                        //loadData方法执行的时候参数必须是JSON对象，而不能是JSON格式的字符串！！！
                        _912(JSON.parse(JSON.stringify(_2018)));
                    } else {
                        console.log('数据解析异常，请定位到14157行！！！');
                    }
                },
